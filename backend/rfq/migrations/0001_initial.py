    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rfqs', to='customer.company', verbose_name='Компания-заказчик')),
                ('contact_person', models.ForeignKey(blank=True, help_text='Контактное лицо со стороны заказчика', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rfqs', to='person.person', verbose_name='Контактное лицо')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='quotations', to='rfq.currency', verbose_name='Валюта предложения')),
                ...
                ('rfq', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quotations', to='rfq.rfq', verbose_name='RFQ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rfq', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='rfq.rfq', verbose_name='RFQ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quotation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='rfq.quotation', verbose_name='Предложение')),
                ('rfq_item', models.ForeignKey(help_text='Соответствующая строка из RFQ', on_delete=django.db.models.deletion.CASCADE, related_name='quotation_items', to='rfq.rfqitem', verbose_name='Строка RFQ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=rfq.models.rfq_file_upload_path, verbose_name='Файл')),
                ...
                ('rfq_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='rfq.rfqitem', verbose_name='Строка RFQ')),
            ],
            options={
